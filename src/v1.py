...
'''
'''
txtAvant = loadFiletxt("data/avant.txt")
txtApres = loadFiletxt("data/apres.txt")
...
input_characters = " abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZéèàùç€%$+*-!?.,:;&\"'()[]/=0123456789\n\t"
target_characters = " abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZéèàùç€%$+*-!?.,:;&\"'()[]/=0123456789\n\t"

total_size = len(input_characters)
train_size = total_size * 2/3

lines_input = txtAvant.split('\n')
lines_output = txtApres.split('\n')

for num_line in range(0,train_size):
    input_text = lines_input[num_line]
		target_text = lines_output[num_line]
